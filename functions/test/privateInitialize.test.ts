...
describe('privateInitialize', () => {
    ...
    test.concurrent('integration test should work when createRemoteHost is true and createExample false', async () => {
        const config: Config = {
        ...
        admin.initializeApp()
        await expect(privateInitialize(true, false, config)).resolves.toBeUndefined()
    }, 10000)
